...
import { Plus, Search, ArrowLeft, UtensilsCrossed, Clock, Users, Sparkles } from "lucide-react"
import { Card, CardContent } from "@/components/ui/card"
import { Badge } from "@/components/ui/badge"

const cardData = [
  {
    link: "/cadastro-refeicoes",
    icon: Plus,
    title: "Cadastrar Refeições",
    description: "Registrar novas refeições no sistema",
  ...
  {
    link: "/refeicoes-servidas",
    icon: Search,
    title: "Consultar Refeições",
    description: "Visualizar refeições já servidas",
    ...
    >
      <CardContent className="p-8 h-full flex flex-col items-center text-center relative">
        ...
        <div className="absolute -top-2 -right-2 z-30">
          <div
            className={`w-10 h-10 bg-gradient-to-r ${color} rounded-full flex items-center justify-center shadow-lg`}
          >
        ...
        {/* Icon container */}
        <div
          className={`relative z-10 w-24 h-24 rounded-3xl bg-gradient-to-br ${color} flex items-center justify-center mb-6 shadow-xl group-hover:shadow-2xl transition-all duration-300 group-hover:scale-110 group-hover:rotate-1`}
        >
        ...
        {/* Hover glow effect */}
        <div
          className={`absolute inset-0 bg-gradient-to-br ${color} opacity-0 group-hover:opacity-5 transition-opacity duration-500 blur-xl`}
        ></div>
      </CardContent>
    </Card>
  )
...
export default function RefeicoesHome() {
  return (
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-6">
        ...
        <div className="text-center mb-16 max-w-5xl">
          <div className="flex items-center justify-center mb-6">
            <UtensilsCrossed className="h-12 w-12 text-emerald-400 mr-4 animate-pulse" />
            <Badge className="bg-white/10 text-white border-white/20 backdrop-blur-sm px-6 py-2 text-sm">
              Sistema de Refeições
            </Badge>
            <Clock className="h-12 w-12 text-blue-400 ml-4 animate-pulse" />
          </div>

          <h1 className="text-5xl md:text-6xl lg:text-8xl font-bold bg-gradient-to-r from-white via-emerald-200 to-blue-200 bg-clip-text text-transparent mb-6 leading-tight">
            Refeições
          </h1>

          <div className="flex items-center justify-center gap-4 mb-6">
            <Badge className="bg-emerald-500/20 text-emerald-300 border-emerald-500/30 px-4 py-2">Cadastro</Badge>
            <span className="text-white/50">•</span>
            <Badge className="bg-blue-500/20 text-blue-300 border-blue-500/30 px-4 py-2">Consulta</Badge>
          </div>

          <p className="text-xl text-white/70 max-w-3xl mx-auto leading-relaxed">
            Gerencie todo o sistema de refeições de forma completa e organizada
          </p>
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl w-full">
          <div className="text-center p-8 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 group hover:bg-white/10 transition-all duration-300">
            ...
            <div className="text-2xl font-bold text-emerald-400 mb-3">Cadastrar</div>
            <div className="text-white/70 text-sm leading-relaxed">
              Registre novas refeições no sistema com informações detalhadas sobre pratos, horários e quantidades
              servidas
            </div>
          </div>
          ...
          <div className="text-center p-8 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 group hover:bg-white/10 transition-all duration-300">
            ...
            <div className="text-2xl font-bold text-blue-400 mb-3">Consultar</div>
            <div className="text-white/70 text-sm leading-relaxed">
              Visualize o histórico completo de refeições servidas com filtros avançados e relatórios detalhados
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl w-full">
          ...
          <div className="text-center p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 group hover:bg-white/10 transition-all duration-300">
            ...
            <div className="text-white/70 text-sm">Hoje</div>
          </div>
          ...
          <div className="text-center p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 group hover:bg-white/10 transition-all duration-300">
            ...
            <div className="text-2xl font-bold text-purple-400 mb-2">1.2K</div>
            <div className="text-white/70 text-sm">Pessoas Atendidas</div>
          </div>
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-4">
          <Badge className="bg-emerald-500/20 text-emerald-300 border-emerald-500/30 px-4 py-2 hover:bg-emerald-500/30 transition-colors cursor-pointer">
            🍽️ Nova Refeição
          </Badge>
          <Badge className="bg-blue-500/20 text-blue-300 border-blue-500/30 px-4 py-2 hover:bg-blue-500/30 transition-colors cursor-pointer">
            📊 Relatório Diário
          </Badge>
          <Badge className="bg-purple-500/20 text-purple-300 border-purple-500/30 px-4 py-2 hover:bg-purple-500/30 transition-colors cursor-pointer">
            👥 Pessoas Atendidas
          </Badge>
          <Badge className="bg-orange-500/20 text-orange-300 border-orange-500/30 px-4 py-2 hover:bg-orange-500/30 transition-colors cursor-pointer">
            ⭐ Avaliações
          </Badge>
        </div>
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-6 max-w-4xl">
          <div className="flex items-center space-x-3 bg-white/5 backdrop-blur-sm rounded-xl px-4 py-3 border border-white/10">
            ...
            <span className="text-white/80 text-sm">Café da Manhã: 06:00 - 09:00</span>
          </div>
          <div className="flex items-center space-x-3 bg-white/5 backdrop-blur-sm rounded-xl px-4 py-3 border border-white/10">
            <div className="w-3 h-3 bg-blue-400 rounded-full animate-pulse"></div>
            <span className="text-white/80 text-sm">Almoço: 11:30 - 14:00</span>
          </div>
          <div className="flex items-center space-x-3 bg-white/5 backdrop-blur-sm rounded-xl px-4 py-3 border border-white/10">
            <div className="w-3 h-3 bg-purple-400 rounded-full animate-pulse"></div>
            <span className="text-white/80 text-sm">Jantar: 17:30 - 20:00</span>
          </div>
        </div>

        {/* Footer info */}
        <div className="mt-12 text-center">
          <p className="text-white/50 text-sm">Instituto Reciclar - Sistema de Gestão de Refeições</p>
        </div>
      </div>
    </div>
  )
